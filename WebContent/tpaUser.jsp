...
<html>
<head>
	<title>Third Party Auditor | Tpa User </title>
	 ...
	 <div class="container">
		 ...
		 <div class="top-menu">
			 <span class="menu"></span>
			   <ul>
				 <li ><a href="bachAuditing.jsp">HOME</a></li>
    ...
    <tbody>
      ...
      <%
       ...
       <%--  <td><a name="file" class="btn btn-launch" data-toggle="modal" href="#" onClick="goTranDeleteBill('<%=rs1.getString(1)%>','<%=rs1.getString(2)%>')" > Download</a></td>
        --%> 
         <td>
          <a href="AuditingServlet?id2=<%=rs1.getString(1) %>"> <span class="label label-primary">Approved</span> </a>
        </td><!-- <span class="label label-warning">Approved</span> -->
      </tr>
     <%
			}
