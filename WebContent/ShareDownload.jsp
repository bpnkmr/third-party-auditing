			   ...
			   <ul>
				 ...
				 <li><a href="uploadFile.jsp">UPLOAD FILE</a></li>
				  <li class="active"><a href="userDownload.jsp">DOWNLOAD</a></li>
				   <li class="active"><a href="UserShare.jsp">Share</a></li>
  ...
  <thead>
    ...
    <tbody>
      ...
      <%
		 ...
		 ShareDao  ud=new ShareDao();
				ResultSet rs1= ud.ShareFile(String.valueOf(id));
       ...
       <%--  <td><a name="file" class="btn btn-launch" data-toggle="modal" href="#" onClick="goTranDeleteBill('<%=rs1.getString(1)%>','<%=rs1.getString(2)%>')" > Download</a></td>
        --%> 
         <td>
          <a href="DownloadFileShareServlet?name=<%=rs1.getString(1)%>&id=<%=rs1.getString(2) %>"> <span class="label label-success">Download</span> </a>
           </td>
          <td>
               <a href="UserDeleteShareServlet?name=<%=rs1.getString(2) %>&id=<%=rs1.getString(1) %>"><span class="label label-primary">Delete</span> </a>
  		</td>
      </tr>
     <%i++;
			}
