...
<html>
<head>
	<title>Third Party Auditor | Register </title>
	<!-- for dropdown login -->
...
<div class="about">
	...
	font-weight: 300;">Registration</h1>
	<br>
  ...
  -->   <div class="col-sm-11" style="margin-left:20px;"> 
    	     <input type="text" class="form-control" id="fullName" name="fullName" placeholder="Full Name" required pattern="[A-Za-z ]{1,50}">
  ...
  <div class="form-group">
   <!--  <label class="control-label col-sm-2" for="pwd" >Password:</label>
  -->   <div class="col-sm-11" style="margin-left:20px;"> 
    	     <input type="text" class="form-control" id="userMobile" name="userMobile" placeholder="Mobile No" required pattern="[0-9]{10,10}" maxlength="10" minlength="10">
  ...
  <div class="form-group">
   <!--  <label class="control-label col-sm-2" for="pwd" >Password:</label>
  -->   <div class="col-sm-11" style="margin-left:20px;"> 
     <input type="password" class="form-control" id="pwd" name="userPass" placeholder="password" pattern="[A-Za-z0-9]{8,8}" maxlength="8" minlength="8">
