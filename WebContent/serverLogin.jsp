...
<html>
<head>
	<title>Third Party Auditor | ServerLogin </title>
			 ...
			 <span class="menu"></span>
			  <ul>
				 <li><a href="index.jsp">HOME</a></li>
			      ...
			      <li class="serverLogin.jsp"><a href="serverLogin.jsp">SERVER</a></li>
...
<div class="about">
	...
	<div  class="modal-content login-modal" style="width:350px; height:250px; background-color:white; margin-left:400px; margin-top:80px;">
	  <form class="form-horizontal" role="form" action="ServerLoginServlet" method="post">
	...
	font-weight: 300;">Login for server</h1>
	<br>
